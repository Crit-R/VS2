...
static const uint64_t MASK64 = 0xFFFFFFFFFFFFFFFFUL;
// ------------------------------------------------
...
#if ((_MSC_VER < 1920) && (WIN64))		/* check for visual studio 2017 */
...
unsigned __int64(__fastcall* _udiv128)(
